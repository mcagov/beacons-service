...
public class CreateRegistrationService {
    ...
    public Beacon register(Beacon beacon) {
        ...
        Optional<List<LegacyBeacon>> matchingLegacyBeacons = legacyBeaconService.findMatchingLegacyBeacons(beacon);

        matchingLegacyBeacons.ifPresent(matches -> matches.forEach(legacyBeaconService::claim));
