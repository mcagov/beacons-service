...
public class LegacyBeaconService {
    ...
    public LegacyBeaconService(
            ...
            EventGateway eventGateway, AccountHolderGateway accountHolderGateway, LegacyBeaconValidator legacyBeaconValidator
    ) {
    ...
    public void claim(LegacyBeacon legacyBeacon) {
        var accountHolder = accountHolderGateway.getByEmail(legacyBeacon.getAssociatedEmailAddress());
        eventGateway.save(new LegacyBeaconClaimEvent(legacyBeacon, accountHolder, OffsetDateTime.now()));
    }
}
