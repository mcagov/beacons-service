...
import uk.gov.mca.beacons.api.exceptions.BeaconsSearchResultSerializerException;
import uk.gov.mca.beacons.api.jpa.entities.Beacon;

public class BeaconsSearchResultSerializer
  extends StdSerializer<BeaconsSearchResultDTO> {

  public BeaconsSearchResultSerializer() {
    super(BeaconsSearchResultDTO.class);
  }

  @Override
  public Class<BeaconsSearchResultDTO> handledType() {
    return BeaconsSearchResultDTO.class;
  }

  @Override
  public void serialize(
    BeaconsSearchResultDTO value,
    JsonGenerator gen,
  ...
  private void writeData(BeaconsSearchResultDTO value, JsonGenerator gen)
    throws IOException {
  ...
  private void writeMeta(BeaconsSearchResultDTO value, JsonGenerator gen)
    throws IOException {
