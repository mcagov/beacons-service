...
public class BeaconsRelationshipMapper {
    ...
    private void setUsesOnBeacon(
        ...
        beacon.setUses(Objects.requireNonNullElse(beaconUses, Collections.emptyList()));
    }
    ...
    private void setContactsOnBeacon(
        ...
        beacon.setEmergencyContacts(Objects.requireNonNullElse(beaconContacts, Collections.emptyList()));
    }
}
