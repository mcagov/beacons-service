...
public class AccountHolderMapper extends BaseMapper {
  ...
  public AccountHolder fromDTO(AccountHolderDTO accountHolderDTO) {
    ...
    accountHolder.setAuthId((String) accountHolderDTO.getAttributes().get("authId"));
    accountHolder.setEmail((String) accountHolderDTO.getAttributes().get("email"));
    accountHolder.setFullName((String) accountHolderDTO.getAttributes().get("fullName"));
    accountHolder.setTelephoneNumber((String) accountHolderDTO.getAttributes().get("telephoneNumber"));
    accountHolder.setAlternativeTelephoneNumber((String) accountHolderDTO.getAttributes().get("alternativeTelephoneNumber"));
    accountHolder.setAddressLine1((String) accountHolderDTO.getAttributes().get("addressLine1"));
    accountHolder.setAddressLine2((String) accountHolderDTO.getAttributes().get("addressLine2"));
    accountHolder.setAddressLine3((String) accountHolderDTO.getAttributes().get("addressLine3"));
    accountHolder.setAddressLine4((String) accountHolderDTO.getAttributes().get("addressLine4"));
    accountHolder.setTownOrCity((String) accountHolderDTO.getAttributes().get("townOrCity"));
    accountHolder.setPostcode((String) accountHolderDTO.getAttributes().get("postcode"));
    accountHolder.setCounty((String) accountHolderDTO.getAttributes().get("county"));
  ...
  public WrapperDTO<AccountHolderDTO> toWrapperDTO(AccountHolder accountHolder) {
