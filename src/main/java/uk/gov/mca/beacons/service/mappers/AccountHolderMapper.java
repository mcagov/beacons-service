...
public class AccountHolderMapper extends BaseMapper {
    ...
    public CreateAccountHolderRequest toCreateAccountHolderRequest(AccountHolderDTO accountHolderDTO) {
        final var attributes = accountHolderDTO.getAttributes();

        return CreateAccountHolderRequest.builder()
                ...
                .county(attributes.getCounty()).build();
    }
